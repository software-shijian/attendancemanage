...
public class DateUtils {
    ...
    public static String getCurrentData() {
        ...
        return getCurrentTimeFormated(DateUtils.YYYY_MM_DD);
    }
    ...
    public static String getCurrentDataTime() {
        return getCurrentTimeFormated(DateUtils.YYYY_MM_DD_HH_MM_SS);
    }
    ...
    public static String getFirstDateOfMonth(String strYYYYMMDD) {
        Calendar caldTmp = Calendar.getInstance();
        // 取得该月第一天日期
        caldTmp.set(DateUtils.getIntYearOfDate(strYYYYMMDD), DateUtils
                .getIntMonthOfDate(strYYYYMMDD) - 1, 1);
        return DateUtils.date2String(caldTmp.getTime(), DateUtils.YYYY_MM_DD);
    }
    ...
    public static String getToday() {
        return DateUtils.date2String(new Date(), DateUtils.YYYY_MM_DD);
    }
